...
import com.trifork.estimote.util.CircularBuffer;
...
import static com.trifork.estimote.R.*;
...
public class BeaconDataFragment extends BaseFragment {
    ...
    public void beaconFound(BeaconScanCompleteEvent event) {
        ...
        lastReadingView.setText(String.format("%s dBm (%s m)", beacon.getRssi(), com.trifork.estimote.util.Utils.formatRange(Utils.computeAccuracy(beacon))));
