...
import com.trifork.estimote.eventbus.OttoEvent;
...
//        beaconManager.setForegroundScanPeriod(5000);
    ...
    public void startRanging() {
        ...
        try {
            ...
            beaconManager.startRangingBeaconsInRegion(com.trifork.estimote.util.Utils.convertRegion(persistentState.getSelectedRegion()));
            rangingStarted = true;
    ...
    public void stopRanging() {
        if (!rangingStarted) return;
        try {
            beaconManager.stopRangingBeaconsInRegion(com.trifork.estimote.util.Utils.convertRegion(persistentState.getSelectedRegion()));
