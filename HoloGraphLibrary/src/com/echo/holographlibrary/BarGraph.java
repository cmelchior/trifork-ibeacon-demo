...
public class BarGraph extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        float maxValue = 0;
        float padding = 1 * resources.getDisplayMetrics().density; // 7
        float bottomPadding = 10 * resources.getDisplayMetrics().density; // 30
        ...
        if (mShowAxis) {
            ...
            canvas.drawLine(0,
                    getHeight() - bottomPadding + 1 * resources.getDisplayMetrics().density,
                    getWidth(),
                    getHeight() - bottomPadding + 1 * resources.getDisplayMetrics().density, mPaint);
        }
